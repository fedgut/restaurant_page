...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return menu; });\n/* harmony import */ var _elementManager__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./elementManager */ \"./src/elementManager.js\");\n\n\nconst menu = (target) => {\n  const type = ['ul', 'li'];\n  const items = [\n    ['Chiken sandwich', 'Bread', 'Chicken', 'Tomatoes', 'Love', '$4,33'],\n    ['Tuna sandwich', 'Bread', 'Tuna', 'Onions', 'Hate', '$3,50'],\n    ['Cheeseburger', 'Cheese', 'Burger', '$13,50'],\n  ];\n  const appender = () => {\n    items.forEach((x) => {\n      const dish = x[0];\n      const ingr = x.slice(1, -1);\n      document.getElementById(target).appendChild(_elementManager__WEBPACK_IMPORTED_MODULE_0__[\"elemental\"]('div', 'id', dish));\n      document.getElementById(dish).appendChild(_elementManager__WEBPACK_IMPORTED_MODULE_0__[\"elemental\"]('h4', 'innerText', dish));\n      document.getElementById(dish).appendChild(_elementManager__WEBPACK_IMPORTED_MODULE_0__[\"listCreator\"](dish, type, ingr));\n      document.getElementById(dish).appendChild(_elementManager__WEBPACK_IMPORTED_MODULE_0__[\"elemental\"]('p', 'innerText', x[x.length - 1]));\n    });\n  };\n  appender();\n};\n\n\n\n\n//# sourceURL=webpack:///./src/menu.js?");
